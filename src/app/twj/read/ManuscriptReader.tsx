...
export default function ManuscriptReader({ chapters, userName }: ManuscriptReaderProps) {
  ...
  async function handleLogout() {
    await fetch('/api/twj/logout', { method: 'POST' })
  ...
  async function handleFeedback(chapterId: string) {
    ...
    try {
      const res = await fetch('/api/twj/feedback', {
        method: 'POST',
                  ...
                  {feedbackSubmitted[activeChapter.id] ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <button
                        ...
                        disabled={
                          feedbackLoading[activeChapter.id] ||
                          !feedbackText[activeChapter.id]?.trim()
                        }
